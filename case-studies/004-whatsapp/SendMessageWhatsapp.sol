...
contract SendMessageWhatsapp {
	...
	constructor(address _applicationWallet){
		...
		var = "teste";
		session = EAI.createSessionInterval( 24, uint8(EAI.TimeUnit.HOUR) );	
		...
		weekDaysInterval_C1.push(EAI.createWeekDaysInterval( uint8(EAI.Day.MONDAY), uint8(EAI.Day.FRIDAY) ));
	}
