...
contract ApiExpandedBasicPlanWebOfScience {
	...
	constructor(address _applicationWallet){
		...
		maxNumberOfOperationByTime_C1.push(EAI.createMaxNumberOfOperationByTime( 2, uint8(EAI.TimeUnit.SECOND) ));
		messageContent_Number_C1.push(EAI.createMessageContent_Number(  "count(//body/document)", "<=", 100 ));
		messageContent_Number_PerTime_C1.push(EAI.createMessageContent_Number_PerTime(  "count(//body/document)", "<=", 50000, uint8(EAI.TimeUnit.MONTH) ));
