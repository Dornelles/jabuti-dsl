...
contract FlightFacade {
	...
	constructor(address _applicationWallet){
		...
		weekDaysInterval_C1.push(EAI.createWeekDaysInterval( uint8(EAI.Day.SUNDAY), uint8(EAI.Day.SATURDAY) ));
		timeInterval_C1.push(EAI.createTimeInterval( 21600, 82740 ));
		maxNumberOfOperationByTime_C1.push(EAI.createMaxNumberOfOperationByTime( 100, uint8(EAI.TimeUnit.MINUTE) ));
