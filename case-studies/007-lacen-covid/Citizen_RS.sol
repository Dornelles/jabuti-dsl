...
contract Citizen_RS {
	...
	constructor(address _applicationWallet){
		...
		maxNumberOfOperationByTime_C1.push(EAI.createMaxNumberOfOperationByTime( 700, uint8(EAI.TimeUnit.MINUTE) ));
		timeInterval_C1.push(EAI.createTimeInterval( 21600, 86399 ));
		maxNumberOfOperationByTime_C1.push(EAI.createMaxNumberOfOperationByTime( 400, uint8(EAI.TimeUnit.MINUTE) ));
		...
		weekDaysInterval_C3.push(EAI.createWeekDaysInterval( uint8(EAI.Day.SUNDAY), uint8(EAI.Day.SATURDAY) ));
